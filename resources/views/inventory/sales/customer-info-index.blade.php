...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row" id="top-head">
            <div class="col-md-6">
                <div class="pull-left">
                    <button type="button" class="btn btn-customer-add btn-primary"><i class="fa fa-plus"></i>New Customer</button>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="row dataTables_wrapper" style="overflow-x:auto;">
            <table class="table table-bordered table-hover table-striped" id="customers-table">
        ...
        {!! Form::open(['url'=>'sales/customerInfoIndex','method'=>'POST']) !!}
        <div id="new-customer" class="col-md-12">
            <table width="100%" class="table table-bordered table-striped table-hover table-info">
                ...
                <tr>
                    ...
                    <td><label for="tax_number" class="control-label">Customer Tax Number</label></td>
        ...
        <div id="edit-customer" class="col-md-8">
...
@push('scripts')
    ...
    <script>
        ...
        $(document).on('click', '.btn-customer-add', function (e) {
            $('#new-customer').show();
            $('#customers-table').parents('div.dataTables_wrapper').first().hide();
            $('#top-head').hide();
        });
