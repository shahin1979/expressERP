        ...
        <div class="row">
            <div class="col-md-10" >
                ...
                <div class="div">
                    ...
                    <table width="75%" class="table table-responsive table-hover" >

                        <tr>
                            <td width="5%"><label for="acc_no" class="control-label" >Customer</label></td>
                            <td width="25%">{!! Form::select('customer_id',$customers, null, array('id' => 'customer_id', 'class' => 'form-control','required')) !!}</td>
                            <td width="5%"><label for="date_from" class="control-label" >From</label></td>
                            <td width="15%">{!! Form::text('invoice_no', null, array('id' => 'invoice_no', 'class' => 'form-control','required')) !!}</td>
