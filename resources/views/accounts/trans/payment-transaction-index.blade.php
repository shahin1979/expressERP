    ...
    <script type='text/javascript'>
        ...
        $(function () {
            ...
            $(document).on('click', '.btn-add', function (e) {
                ...
                $("#transForm").find('input.head-balance').each(function () {
...
// GET SELECTED CREDIT HEAD BALANCE

        jQuery(document).ready(function($) {
            $('#acc_cr').change(function(){
                $.get("{!! url('transaction/creditBalance')  !!}", { option: $('#acc_cr').val() },
                    function(data) {
...
{{--    <input type="hidden" name="minDate" value="{!! $min_date !!}"/>--}}
{{--    <input type="hidden" name="maxDate" value="{!! $max_date !!}"/>--}}
            ...
            <div class="controls">
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td width="20%">{!! Form::text('trans_date', Carbon\Carbon::now()->format('d-m-Y') , array('id' => 'trans_date', 'class' => 'form-control','readonly' => 'true', 'data-mg-required' => '')) !!}</td>
                    </tr>
...
@push('scripts')
    <script>
        ...
        $(document).ready(function(){
            ...
            var max_date = new Date(document.getElementById('maxDate').value);
