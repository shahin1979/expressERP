    ...
    <div class="container spark-screen">
        <div class="row" id="current">
            <div class="col-md-8 col-md-offset-1" >
                ...
                <div class="div">
                    <br/>
                    {!! Form::open(['url'=>'accounts/report/rptTrialBalanceIndex', 'method' => 'GET']) !!}
                    ...
                    <table class="table table-striped table-bordered table-hover table-responsive">
                        ...
                        @foreach($report as $i=>$row)
                            ...
                            <tr style="background-color: {!! $i % 2 == 0 ? '#ffffff': '#afffff' !!}">
                                <td>{!! $row['acc_no'] !!}</td>
                                <td style="text-align: left"><a href="{!! url('accounts/report/'.$row['acc_no'].'/'.$params['toDate']) !!}" class="btn btn-primary">{!! $row['acc_name'] !!}</a></td>
                                <td>{!! $row['acc_type'] !!}</td>
