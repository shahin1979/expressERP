    ...
    <div class="container spark-screen">
        ...
        <div class="row" id="previous">
            <div class="col-md-8 col-md-offset-1" >
                ...
                <div class="div">
                    <br/>
                    {!! Form::open(['url'=>'ledger/prevTrialBalanceIndex', 'method' => 'GET']) !!}
                    ...
                    <table width="80%" class="table table-responsive table-hover" >
                        ...
                        <tr>
                            ...
                            <td width="10%">{!! Form::text('report_date', Carbon\Carbon::now()->format('d-m-Y'), array('id' => 'report_date', 'class' => 'form-control','required','readonly')) !!}</td>
                        </tr>
                        <tr>
