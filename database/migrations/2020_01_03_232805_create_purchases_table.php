...
class CreatePurchasesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('purchases', function (Blueprint $table) {
            ...
            $table->integer('ref_no',false)->unsigned()->comments('purchase ref#, l/c #');
            $table->char('purchase_type',1)->comments('L = Local Purchase, I = Import B=b2b l/c'); //1 for consumption 2 for purchase
            $table->date('purchase_date');
            $table->integer('supplier_id')->unsigned()->nullable()->index('FK_purchase_relationships')->comments('Suppliers');
