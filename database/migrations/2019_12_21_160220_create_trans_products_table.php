...
class CreateTransProductsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('trans_products', function (Blueprint $table) {
            ...
            $table->decimal('quantity',15,4)->default(0.00);
            ...
            $table->decimal('approved',15,4)->default(0.00);
            $table->decimal('purchased',15,4)->default(0.00);
            $table->decimal('sold',15,4)->default(0.00);
