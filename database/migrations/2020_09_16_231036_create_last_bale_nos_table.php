...
class CreateLastBaleNosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('last_bale_nos', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('company_id')->unsigned();
            $table->foreign('company_id')->references('id')->on('companies')->onDelete('CASCADE');
            $table->unsignedSmallInteger('line_no',false)->default(1);
    ...
    {
        Schema::dropIfExists('last_bale_nos');
    }
}
