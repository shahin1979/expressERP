...
//            $table->foreign('relationship_id')->references('id')->on('relationships')->onDelete('CASCADE');
            ...
            $table->decimal('initial_price',15,4)->default(0.00);
            $table->decimal('buy_price',15,4)->default(0.00);
            ...
            $table->decimal('reorder_point',15,4)->nullable()->default(0);
            $table->decimal('opening_qty',15,4)->default(0);
            $table->decimal('opening_qty_unit_two',15,4)->default(0);
            $table->decimal('opening_qty_unit_three',15,4)->default(0);
            $table->decimal('opening_value',15,4)->default(0);
            $table->decimal('on_hand',15,4)->default(0);
            $table->decimal('on_hand_unit_two',15,4)->default(0);
            $table->decimal('on_hand_unit_three',15,4)->default(0);
            $table->date('expiry_date')->nullable();
            $table->decimal('committed',15,4)->default(0);
            $table->decimal('in_coming',15,4)->default(0);
            $table->decimal('max_online_stock',15,4)->default(0);
            $table->decimal('min_online_order',15,4)->default(0);
            $table->decimal('purchase_qty',15,4)->default(0);
            $table->decimal('purchase_qty_unit_two',15,4)->default(0);
            $table->decimal('purchase_qty_unit_three',15,4)->default(0);
            $table->decimal('sell_qty',15,4)->default(0);
            $table->decimal('sell_qty_unit_two',15,4)->default(0);
            $table->decimal('sell_qty_unit_three',15,4)->default(0);
            $table->decimal('salvage_qty',15,4)->default(0);
            $table->decimal('salvage_qty_unit_two',15,4)->default(0);
            $table->decimal('salvage_qty_unit_three',15,4)->default(0);
            $table->decimal('received_qty',15,4)->default(0);
            $table->decimal('received_qty_unit_two',15,4)->default(0);
            $table->decimal('received_qty_unit_three',15,4)->default(0);
            $table->decimal('return_qty',15,4)->default(0);
            $table->decimal('return_qty_unit_two',15,4)->default(0);
            $table->decimal('return_qty_unit_three',15,4)->default(0);
