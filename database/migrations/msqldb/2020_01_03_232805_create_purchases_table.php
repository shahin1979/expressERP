...
class CreatePurchasesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('purchases', function (Blueprint $table) {
            ...
            $table->char('status',2)->default(1)->comments('CR = created, AP= approved, RC= received, PR= purchased,  DL=delivered, RJ= rejected, RT=>Returned CL=closed');
            $table->char('stock_status',1)->default('A')->comments('A = Available, F=FINISHED');
