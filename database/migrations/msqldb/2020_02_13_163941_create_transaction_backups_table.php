...
class CreateTransactionBackupsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('transaction_backups', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('transaction_backups');
    }
}
