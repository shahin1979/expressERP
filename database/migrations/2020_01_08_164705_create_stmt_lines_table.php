...
class CreateStmtLinesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('stmt_lines', function (Blueprint $table) {
            ...
            $table->decimal('range_val1',15,4)->nullable()->default(0);
            $table->decimal('print_val1',15,4)->nullable()->default(0);
            $table->decimal('range_val2',15,4)->nullable()->default(0);
            $table->decimal('print_val2',15,4)->nullable()->default(0);
            $table->decimal('range_val3',15,4)->nullable()->default(0);
            $table->decimal('print_val3',15,4)->nullable()->default(0);
            $table->decimal('print_val',15,4)->nullable()->default(0);
            $table->decimal('pcnt',15,4)->nullable()->default(0);
